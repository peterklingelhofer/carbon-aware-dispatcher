...
# with the number. It is a location-based benchmark, NOT marginal/additional
...
SAVINGS_BASIS = (
    ...
    "benchmark, not marginal/additional"
)
...
def suggest_green_cron(zone):
    ...
    # regions, not all). Treat the cron as a starting point, not a guarantee
