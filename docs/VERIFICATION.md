...
| 5 | The EPA equivalence factors | **FIXED.** All three had drifted, and the tree figure was off by a factor of 2.9 |
| 6 | Any direct measurement of GitHub-hosted runner energy | **UNRESOLVABLE.** None exists publicly, and the hypervisor blocks RAPL |
...
and not behind-the-meter rooftop. Nine pinned test expectations moved with them, and
...
| `auto:cleanest` preset | "Checks all free-provider zones" | 16 curated zones. The code comment said "a smart subset", and the README said "all" |
