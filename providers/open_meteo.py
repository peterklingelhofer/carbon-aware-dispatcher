...
ZONE_COORDINATES = {
    ...
    "SA": (24.7, 46.7),  # Saudi Arabia Riyadh. AU-SA is the Australian zone
...
def check_carbon_intensity(zone, max_carbon, lat=None, lon=None):
    ...
    if lat is None or lon is None:
        ...
        if coords is None:
            print(
                f"::warning::No coordinates for zone '{zone}' in Open-Meteo provider. "
    ...
    print(f"  (Solar: {solar:.0f} W/m², Wind: {wind:.1f} m/s, estimated)")
...
def get_forecast(zone, max_carbon, lat=None, lon=None):
    ...
    print("  Forecast: no estimated green window in 48h Open-Meteo forecast.")
